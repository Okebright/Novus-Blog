...
if (isset($_GET['search-items']) && !empty($_GET['search-items'])) {
    $search = $_GET['search-items'];
    $item = "%$search%";

    // Fetch the category details from the database
    $sql = "SELECT * FROM posts WHERE title LIKE '$item' OR content LIKE '$item'";
...
<header class="home-hero">
    <div class="hero-minimal">
        <h1><span style="font-weight: bold; color: grey;">Search Result:</span> <?php echo " " . $search; ?> </h1>
        ...
        <section class="latest-posts">
            <div class="posts-header">
                <div>
                    ...
                    ?>
                    <h2><?php echo $search . " "; ?> <span style="font-weight: bold; color: grey;">Search Result</span></h2>
